# Heart of the Cards
This is the repo for the Heart of the Cards Blog Series, a series where I use data I routinely pull from YGOPRO to practice my data science skills and write about the experience. You can find the blog here: [INCLUDE LINK]. 
